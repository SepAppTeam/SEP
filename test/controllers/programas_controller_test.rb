...
class ProgramasControllerTest < ActionController::TestCase
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post :create, programa: { centro_id: @programa.centro_id, codigo: @programa.codigo, nombre: @programa.nombre, titulacion_id: @programa.titulacion_id, version: @programa.version }
    end
  ...
  test "should update programa" do
    patch :update, id: @programa, programa: { centro_id: @programa.centro_id, codigo: @programa.codigo, nombre: @programa.nombre, titulacion_id: @programa.titulacion_id, version: @programa.version }
    assert_redirected_to programa_path(assigns(:programa))
  end
