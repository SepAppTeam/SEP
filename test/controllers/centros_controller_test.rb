...
class CentrosControllerTest < ActionController::TestCase
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post :create, centro: { codigo: @centro.codigo, direccion: @centro.direccion, nombre: @centro.nombre }
    end
  ...
  test "should update centro" do
    patch :update, id: @centro, centro: { codigo: @centro.codigo, direccion: @centro.direccion, nombre: @centro.nombre }
    assert_redirected_to centro_path(assigns(:centro))
  end
